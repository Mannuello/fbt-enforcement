from data_tools import (get_all_car_data_records,
...
if __name__ == "__main__":
    ...
    plate_number = read_plate_from_image(plate_path) # manny 
    all_car_records = get_all_car_data_records()
    car_record = get_single_car_data(plate_number, all_car_records) # manny
